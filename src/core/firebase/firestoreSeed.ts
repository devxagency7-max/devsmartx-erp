...
export async function seedFirestoreIfEmpty(): Promise<void> {
  await Promise.all([
    ...
    seedCollection('partners', [
      { code: 'PARTNER-001', name: 'Ahmed Hassan', email: 'ahmed@example.com', phone: '+201001234567', status: 'active', createdAt: '2026-01-01T00:00:00Z', updatedAt: '2026-01-01T00:00:00Z' },
      { code: 'PARTNER-002', name: 'Sara Mohamed', email: 'sara@example.com', phone: '+201009876543', status: 'active', createdAt: '2026-01-01T00:00:00Z', updatedAt: '2026-01-01T00:00:00Z' },
    ]),
